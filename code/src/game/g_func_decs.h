...
extern void G_TriggerList_f ( void ) ;
extern void G_TriggerUseByName_f ( gentity_t * activator ) ;
...
extern void dllEntry ( vmArg_t ( QDECL * syscallptr ) ( vmArg_t arg , ... ) ) ;
...
extern qboolean PM_UseHL1Movement ( void ) ;
